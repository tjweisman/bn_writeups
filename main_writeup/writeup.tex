...
\title{Realization of groups with pairing as Jacobians of finite graphs}
...
Let $G_1$ and $G_2$ be graphs with a base point. Then $\Jac(G_1 \vee
G_2) \simeq \Jac(G_1) \times \Jac(G_2)$.
\end{prop}
...
require the following bound on the genus of $G$.

\begin{prop}\cite[Proposition 5.2]{Lorenzini1989}
...
\begin{proof}
  ...
  and $a \equiv 3 \pmod 8$, $b \equiv -3 \pmod 8$. 
