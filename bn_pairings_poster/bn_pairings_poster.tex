...
\definecolor{mit}{cmyk}{.34,.72,1,.33}
\definecolor{wil}{cmyk}{0.5,1,0,.6}
\definecolor{silver}{cmyk}{0,0,0,0.3}
\definecolor{yellow}{cmyk}{0,0,0.9,0.0}
\definecolor{reddishyellow}{cmyk}{0,0.22,1.0,0.0}
\definecolor{black}{cmyk}{0,0,0.0,1.0}
%\definecolor{black}{cmyk}{.34,.72,1,.33}
\definecolor{darkYellow}{cmyk}{0,0,1.0,0.5}
\definecolor{darkSilver}{cmyk}{0,0,0,0.1}
\definecolor{lightyellow}{cmyk}{0,0,0.3,0.0}
\definecolor{lighteryellow}{cmyk}{0,0,0.1,0.0}
\definecolor{lightestyellow}{cmyk}{0,0,0.08,0.0}
\begin{poster}{
  grid=no,
  columns=3,
   colspacing=1em,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{{\bf{Acknowledgements}}}{name=ack,column=0,span=3,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \smaller
  This research was conducted as part of the 2014 SUMRY program at Yale University. We would like to thank our mentors as well as Sam Payne, Nathan Kaplan, Anup Rao, and Susie Kimport for many helpful conversations and suggestions.
}%
...
If you can get between two divisors $D$ and $D'$ via a sequence of chip-firing moves, then $D,D'$ are \textbf{equivalent}, $D\sim D'$.
...
\Jac(G) = \Div^0(G)/\sim.
\]
For any connected graph $G$, $\Jac(G)$ is a finite abelian group.
...
\draw (0,0) to [out=320,in=220] (6,0) ;
\draw (0,0) to [out=335,in=205] (6,0) ;
\draw (0,0) to [out=25,in=155] (6,0) ;
\draw (0,0) to [out=40,in=140] (6,0) ;
...
\begin{claim*}
There exists $q$, a nonresidue mod $p$, such that $q^2/4<p^r$ and $q\equiv 3\pmod 4$ if $r$ is odd and $q\equiv 1\pmod 4$ if $r$ is even.
\end{claim*}
Given this claim, we pick $m$ such that $p^r\equiv m(q-m)\pmod q$, and construct the following \textbf{subdivided banana graph} (fig. 3):
...
%subdivided banana
\draw [shift={(6.5cm,0cm)}] (0,0) to (1,-1) ;
\draw [shift={(6.5cm,0cm)}] (6,0) to (5,-1) ;
\draw [shift={(6.5cm,0cm)}] [dashed] (1,-1) to (5, -1) ;
\draw [shift={(6.5cm,0cm)}] (0,0) to (1.5,0) ;
\draw [shift={(6.5cm,0cm)}] (4.5,0) to (6,0) ;
\draw [shift={(6.5cm,0cm)}] [dashed] (1.5, 0) to (4.5, 0) ;
\draw [shift={(6.5cm,0cm)}] (0,0) to  (.85,1) ;
\draw [shift={(6.5cm,0cm)}] (.85,1) to (2,1.20) ;
\draw [shift={(6.5cm,0cm)}] (5.15,1) to (6,0) ;
\draw [shift={(6.5cm,0cm)}] (4,1.20) to (5.15,1) ;
\draw [shift={(6.5cm,0cm)}] [dashed] (2,1.2) to (4,1.2);
\draw [shift={(6.5cm,0cm)}] (.5, .1) to [out=90, in=-90] (3,.6) ; 
\draw [shift={(6.5cm,0cm)}] (5.5, .1) to [out=90, in=-90] (3,.6) ; 
\draw [shift={(6.5cm,0cm)}] (.5, -.7) to [out=-90, in=90] (3,-1.7) ; 
\draw [shift={(6.5cm,0cm)}] (5.5, -.7) to [out=-90, in=90] (3,-1.7) ; 
\draw [shift={(6.5cm,0cm)}] (.5, .9) to [out=90, in=-90] (3,1.9) ; 
\draw [shift={(6.5cm,0cm)}] (5.5, .9) to [out=90, in=-90] (3,1.9) ; 

\draw [shift={(6.5cm,0cm)}] [fill=green] (6,0) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (1.5,0) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (4.5,0) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill=green] (0,0) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (.85,1) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (2,1.2) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (4,1.2) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (5.15,1) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (1,-1) circle [radius=0.1cm] ;
\draw [shift={(6.5cm,0cm)}] [fill] (5,-1) circle [radius=0.1cm]  ;

\node [shift={(3.25cm,0cm)}] [left]  at (-.2,0) {$0$} ;
\node [shift={(3.25cm,0cm)}] [right] at (6.1,0) {$\;\frac{m(q-m)(p^r-m(q-m))}{q}$} ;
\node [shift={(3.25cm,0cm)}] at (3, .7) {$\;q-m$} ;
\node [shift={(3.25cm,0cm)}] at (3, -2) {$\;m$} ;
\node [shift={(3.25cm,0cm)}] at (3, 2.35) {$\;(p^r-m(q-m))/q$} ;

\node at (4,-2.5) {\textbf{(fig. 2)}} ;
\node at (15,-2.5) {\textbf{(fig. 3)}} ;

\end{tikzpicture}
\end{center}

This construction gives us the nonresidue pairing on $\Z/p^r\Z$ with $p\equiv 1\pmod 4$, provided that the above claim holds. For $r\ge2$, we have a proof of this claim. In the case that $r=1$, the result is implied by the \textbf{Generalized Riemann Hypothesis}. 
