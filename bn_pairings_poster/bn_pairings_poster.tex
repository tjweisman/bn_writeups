...
Let $\Gamma$ be a finite abelian group. A \textbf{pairing} on $\Gamma$ is a map
\[
\pair{\cdot}{\cdot}:\Gamma\times\Gamma\to\Q/\Z.
\]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \headerbox{{\bf{Classification theorem}}}{name=class,column=0,below=defs, above=ack}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
